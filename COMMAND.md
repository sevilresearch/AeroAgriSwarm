...
#### 9. Run Agriswarm simulation only:

    Terminal 1: python3 main.py

#### 10. Run Agriswarm simulation and crazyflie integration:

    Terminal 1: ros2 run crazyflie_missions crazyflie_bridge_multi
    Terminal 2: ros2 run crazyflie_missions waypoint_manager_multi
    Terminal 3: ros2 run crazyflie_missions agriswarm_node
    Terminal 4: python3 main.py (optional: simulation visualization)
